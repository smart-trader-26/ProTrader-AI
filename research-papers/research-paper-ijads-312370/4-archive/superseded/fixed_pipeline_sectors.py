...
json.dump(out, open(os.path.join(OUT, 'fixed_results_sectors.json'), 'w'), indent=2)
strat.to_csv(os.path.join(OUT, 'fixed_strategy_returns_sectors.csv'))
W.to_csv(os.path.join(OUT, 'fixed_weights_sectors.csv'))
