% =============================================================================
% Journal of Universal Computer Science (J.UCS) submission.
% "Accounting for Decision Value: Why Calibration and Selection, not Prediction,
%  Carry a Deployed Equity-Forecasting System."
%
% J.UCS house style is emulated with standard LaTeX so the file compiles under
% pdflatex without the proprietary jucs2e package: A4, one column, Times,
% 10pt body / 9pt small, dot-less section numbers, [Author Year] citations,
% abstract + keywords + ACM category blocks, no running heads. Final pagination
% is assigned by the editor; draft page numbers are kept for review.
%
...
% Items marked "schematic"/"illustrative" carry no performance claim.
% =============================================================================
\documentclass[10pt,a4paper,oneside]{article}

\usepackage[T1]{fontenc}
\usepackage[utf8]{inputenc}
\usepackage{mathptmx}                 % Times for text and math (J.UCS)
\usepackage[a4paper,left=4.6cm,right=4.2cm,top=3.7cm,bottom=6.6cm]{geometry}
...
% ---- J.UCS-style headings: dot-less numbers, serif bold, graded sizes --------
\titleformat{\section}{\bfseries\fontsize{12}{14}\selectfont}{\thesection}{0.7em}{}
...
\frenchspacing
\pagestyle{plain}     % draft page numbers in the footer; no running heads
...
% =============================================================================
% Title block (J.UCS: 14pt bold title, 10pt author names, 9pt affiliations)
% =============================================================================
\thispagestyle{plain}
\begin{center}
{\fontsize{14}{17}\selectfont\bfseries
Accounting for Decision Value: Calibration and Selection\\[2pt]
over Prediction in a Deployed Equity-Forecasting System\par}
\vspace{1.1em}

{\fontsize{10}{12}\selectfont\bfseries Anandkumar Pardeshi\par}
{\fontsize{9}{11}\selectfont
(Department of Computer Science and Engineering,\\
Fr.\ C.\ Rodrigues Institute of Technology, University of Mumbai, Navi Mumbai, India\\
\href{https://orcid.org/0000-0002-1825-0097}{orcid.org/0000-0002-1825-0097}, anand.pardeshi@fcrit.ac.in)\par}
\vspace{0.7em}

{\fontsize{10}{12}\selectfont\bfseries Sujata Deshmukh\par}
{\fontsize{9}{11}\selectfont
(Department of Computer Engineering,\\
Fr.\ C.\ Rodrigues Institute of Technology, University of Mumbai, Navi Mumbai, India\\
\href{https://orcid.org/0000-0001-5109-3700}{orcid.org/0000-0001-5109-3700}, sujata.deshmukh@fcrit.ac.in)\par}
\end{center}
\vspace{0.6em}

% ---- Abstract / Keywords / Category (9pt) -----------------------------------
{\fontsize{9}{11}\selectfont
...
\smallskip
\noindent\textbf{Key Words:} decision value, calibration, selective prediction,
probabilistic forecasting, financial machine learning, model evaluation, abstention

\smallskip
\noindent\textbf{Category:} I.2.6, G.3
\par}
\vspace{0.4em}
...
The construction is not a curiosity. A system whose scores are slightly
...
The recommendation is concrete and portable. Audit deployed uncertainty against a live
ledger. Report precision at a fixed firing rate rather than accuracy or AUC. Attribute
realised value to drift, selection and calibration separately, so that effort goes to
the component that is actually paying. A great deal of financial-ML work optimises the
ranking term, which our results suggest is the one term least likely to survive
deployment.
